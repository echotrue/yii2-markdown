...
class Upload
{
    ...
    public $formats        = ['gif', 'jpg', 'jpeg', 'png', 'bmp'];//允许上传的文件格式
    ...
    public function upload($name)
    {
        ...
        {
            mkdir($this->savePath);
            chmod($this->savePath, 0777);//设置目录权限为0777
    ...
    private function setSeveName()
    {
        ...
        if ($this->randomFileName() == '') //如果没生成随机文件名，就保留原文件名
        {
